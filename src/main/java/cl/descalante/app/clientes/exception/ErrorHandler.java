package cl.descalante.app.clientes.exception;
...
public class ErrorHandler {
    ...
    public ResponseEntity<ErrorInfo> handlerScriptException(HttpServletRequest request, ScriptException e) {
    	log.info("Se detecta exception handlerScriptException");
		log.info(MENSAJE_400);
		log.error(e.getLocalizedMessage());
        ErrorInfo errorInfo = new ErrorInfo(HttpStatus.NOT_FOUND.value(), e.getMessage(), request.getRequestURI());
        return new ResponseEntity<>(errorInfo, HttpStatus.NOT_FOUND); 	
